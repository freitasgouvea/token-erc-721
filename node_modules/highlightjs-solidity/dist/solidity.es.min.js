...
lexemes:C,keywords:p}),x={className:"built_in",
begin:(E()?"(?<!\\$)\\b":"\\b")+"(gas|value|salt)(?=:)"};function w(e,a){return{
...
lexemes:C,contains:[a,s,u,m,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,b,x,O,{
className:"function",lexemes:C,
beginKeywords:"function modifier event constructor fallback receive error",
end:/[{;]/,excludeEnd:!0,
contains:[y,N,x,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE],illegal:/%/
},w("msg","gas value data sender sig"),w("block","blockhash coinbase difficulty gaslimit basefee number timestamp chainid"),w("tx","gasprice origin"),w("abi","decode encode encodePacked encodeWithSelector encodeWithSignature"),w("bytes","concat"),f,{
...
},y,N,x,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},{lexemes:C,
